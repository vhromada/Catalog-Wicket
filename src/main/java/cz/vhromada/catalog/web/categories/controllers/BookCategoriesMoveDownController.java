...
/**
 * A class represents controller for moving down book category.
 *
 * @author Vladimir Hromada
 */
@Component("bookCategoriesMoveDownController")
public class BookCategoriesMoveDownController extends Controller<IModel<BookCategoryTO>> {
    ...
    /**
     * Creates a new instance of BookCategoriesMoveDownController.
     *
     * @param bookCategoryFacade facade for book categories
     * @throws IllegalArgumentException if facade for book categories is null
     */
    @Autowired
    public BookCategoriesMoveDownController(final BookCategoryFacade bookCategoryFacade) {
    ...
    public void handle(final IModel<BookCategoryTO> data) {
        bookCategoryFacade.moveDown(data.getObject());
    ...
    @Override
    public Flow getFlow() {
        return CatalogFlow.BOOK_CATEGORIES_MOVE_DOWN;
    }
