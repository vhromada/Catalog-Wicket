...
/**
 * A class represents controller for updating book category.
 *
 * @author Vladimir Hromada
 */
@Component("updateBookCategoryConfirmController")
public class UpdateBookCategoryConfirmController extends Controller<IModel<BookCategoryMO>> {
    ...
    /**
     * Creates a new instance of UpdateBookCategoryConfirmController.
     *
     ...
     */
    @Autowired
    public UpdateBookCategoryConfirmController(final BookCategoryFacade bookCategoryFacade,
    ...
    public void handle(final IModel<BookCategoryMO> data) {
        bookCategoryFacade.update(converter.convert(data.getObject(), BookCategoryTO.class));
    ...
    @Override
    public Flow getFlow() {
        return CatalogFlow.BOOK_CATEGORIES_UPDATE_CONFIRM;
    }
