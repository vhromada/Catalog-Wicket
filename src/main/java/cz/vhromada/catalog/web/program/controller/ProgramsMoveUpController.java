...
/**
 * A class represents controller for moving up program.
 *
 * @author Vladimir Hromada
 */
@Component("programsMoveUpController")
public class ProgramsMoveUpController extends AbstractResultController<IModel<Program>> {
    ...
    /**
     * Creates a new instance of ProgramsMoveUpController.
     *
     * @param programFacade facade for programs
     * @throws IllegalArgumentException if facade for programs is null
     */
    @Autowired
    public ProgramsMoveUpController(final ProgramFacade programFacade) {
    ...
    public void handle(final IModel<Program> data) {
        addResults(programFacade.moveUp(data.getObject()));
