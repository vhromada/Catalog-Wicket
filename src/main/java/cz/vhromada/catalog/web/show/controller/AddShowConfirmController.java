...
public class AddShowConfirmController extends AbstractResultController<IModel<ShowMO>> {
     ...
     */
    @Autowired
    public AddShowConfirmController(final ShowFacade showFacade, final Converter converter) {
    ...
    public void handle(final IModel<ShowMO> data) {
        addResults(showFacade.add(converter.convert(data.getObject(), Show.class)));
