...
public class MoviesMoveUpController extends AbstractResultController<IModel<Movie>> {
    ...
    /**
     * Creates a new instance of MoviesMoveUpController.
     *
    ...
    @Override
    public Flow getFlow() {
        return CatalogFlow.MOVIES_MOVE_UP;
    }
