 ...
 */
@Component("picturesNewDataController")
public class PicturesNewDataController extends AbstractResultController<Void> {
    ...
    /**
     * Creates a new instance of PicturesNewDataController.
     *
     * @param pictureFacade facade for pictures
     * @throws IllegalArgumentException if facade for pictures is null
     */
    @Autowired
    public PicturesNewDataController(final PictureFacade pictureFacade) {
    ...
    public void handle(final Void data) {
        addResults(pictureFacade.newData());
    ...
    @Override
    public Flow getFlow() {
        return CatalogFlow.PICTURES_NEW_DATA;
    }
