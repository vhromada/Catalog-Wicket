...
import cz.vhromada.catalog.web.season.panel.SeasonsListPanel;
...
public class SeasonsListController extends AbstractResultController<Void> {
     ...
     */
    @Autowired
    public SeasonsListController(final SeasonFacade seasonFacade, final EpisodeFacade episodeFacade) {
