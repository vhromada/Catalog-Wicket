...
public class GamesMoveDownController extends AbstractResultController<IModel<Game>> {
    ...
    public void handle(final IModel<Game> data) {
        addResults(gameFacade.moveDown(data.getObject()));
    ...
    @Override
    public Flow getFlow() {
        return CatalogFlow.GAMES_MOVE_DOWN;
    }
